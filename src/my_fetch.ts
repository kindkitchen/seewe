    ...
    if (!is_public_api) {
      ...
      if (!access_token) {
        ...
        throw new UiException(
          "login_is_required",
          "it looks like logout happen before",
        );
      }
      req_init.headers = {
...
type ApiCallPayload<M extends v1_.Method, P extends v1_.Path> =
  v1_.Req<M, P>["headers"] extends
    | undefined
    | never ? Omit<v1_.Req<M, P>, "headers"> & { is_public_api: true }
    : Required<Required<v1_.Req<M, P>>["headers"]> extends Omit<
      Record<string, string>,
      "authorization"
    > ? v1_.Req<M, P> & { is_public_api: true }
    : Omit<
      Required<Required<v1_.Req<M, P>>["headers"]>,
      "authorization"
    > extends Record<
      string,
      never
