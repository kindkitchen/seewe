...
<template>
  <label :class="tw(' inline-flex items-center cursor-pointer', data.class as any)">
    ...
    ></div>
    <span class="ms-3 uppercase text-sm font-medium text-gray-900 dark:text-gray-300">
      <slot v-bind="{ checked }"></slot>
    </span>
  </label>
</template>
