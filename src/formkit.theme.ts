 ...
 *
 * @checksum - f57ee05ec7e29ff042f1c595ce342e7e2e86cf1bac2fb6fa8d55d20c4eba9d75
 * @variables - radius=rounded,accentColor=slate,colorTemperature=slate,spacing=1.5,scale=sm,inputShadow=shadow-none,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=600,inputMaxWidth=max-w-[15em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-slate-400": true,
    "peer-checked:border-slate-500": true,
    relative: true,
    block: true,
    "text-base": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-slate-50": true,
    "peer-checked:text-slate-500": true,
    ...
    "dark:ring-offset-slate-400": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-slate-600/50": true,
    "dark:peer-checked:bg-slate-800": true,
    "dark:peer-checked:text-slate-300": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-slate-400": true,
    "focus-within:!border-slate-400": true,
  ...
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-slate-400": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-slate-100": true,
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "cursor-pointer": true,
    "dark:text-slate-200": true,
    "dark:hover:text-slate-400": true,
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-slate-400": true,
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-slate-300": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-slate-500": true,
  },
  button__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  color__inner: {
    ...
    "dark:group-data-[prefix-icon]:border-slate-600": true,
    "dark:group-data-[suffix-icon]:border-slate-600": true,
  },
  color__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  date__input: {
    ...
    "selection:text-slate-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-slate-100": true,
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-slate-100": true,
  },
  file__fileList: {
    "group/list": true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-slate-500": true,
  ...
  form__messageLink: {
    ...
    "group-[]/summary:ring-slate-500": true,
  },
  month__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:bg-slate-500": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-slate-400": true,
    ...
    "[&::-moz-range-thumb]:bg-slate-500": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-slate-400": true,
  ...
  select__option: {
    ...
    "group-data-[multiple]:checked:bg-slate-100": true,
    "group-data-[multiple]:focus:bg-slate-100": true,
    ...
    "dark:bg-slate-800": true,
    "dark:text-slate-300": true,
    "dark:group-data-[multiple]:focus:bg-slate-700": true,
    "dark:group-data-[multiple]:checked:bg-slate-700": true,
  },
  select__prefixIcon: {
    flex: true,
    "items-center": true,
  ...
  submit__input: {
    ...
    "bg-slate-500": true,
    "!text-white": true,
    "active:text-slate-100": true,
    "active:bg-slate-600": true,
    "hover:bg-slate-600": true,
  ...
  week__input: {
    ...
    "selection:text-slate-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-slate-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-slate-100": true,
  },
  ...
  autocomplete__selectionWrapper: {
    ...
    "dark:group-data-[multiple]:border-slate-600": true,
  ...
  colorpicker__control: {
    ...
    "focus-visible:ring-slate-400": true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input]:selection:bg-slate-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-slate-500": true,
    "[&>input:focus]:border-slate-500": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-slate-400": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-slate-600": true,
    "dark:text-slate-300": true,
    "dark:aria-selected:bg-slate-500": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-slate-500": true,
  ...
  datepicker__timeInput: {
    ...
    "p-1.5": true,
    "my-2": true,
    "focus-visible:outline-slate-500": true,
    "dark:text-slate-300": true,
    "dark:bg-transparent": true,
    "dark:border-slate-700": true,
  },
  ...
  datepicker__dayButton: {
    ...
    "dark:text-slate-300": true,
    "dark:border-slate-700": true,
    "dark:hover:border-slate-400": true,
  },
  ...
  datepicker__calendarIcon: {
    "text-slate-600": true,
    "focus-visible:text-slate-500": true,
    flex: true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  rating__ratingItem: {
    ...
    "focus-within:outline-slate-500": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true,
  },
  ...
  slider__minValue: {
    ...
    "dark:[&>div>div::after]:bg-slate-600": true,
  },
  slider__maxValue: {
    grow: true,
    "!max-w-[45%]": true,
  ...
  toggle__track: {
    ...
    "transition-all": true,
    "bg-slate-400": true,
    "peer-checked:bg-slate-500": true,
    ...
    "shadow-none": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-slate-400": true,
  ...
  togglebuttons__input: {
    ...
    "dark:text-slate-500": true,
    "aria-[pressed=true]:bg-slate-500": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-slate-500": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-slate-500":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-slate-500":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-slate-500":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-slate-500":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-slate-500":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-slate-500":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-slate-500":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-slate-500":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-slate-500":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-slate-500":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-slate-500":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-slate-500":
      true,
  },
  transferlist__outer: {
    group: true,
    ...
    "text-sm": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-slate-500": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-slate-400": true,
    "dark:border-slate-700": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "data-[is-active=true]:ring-slate-200": true,
    "aria-selected:ring-slate-200": true,
    relative: true,
    flex: true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-slate-800": true,
    "dark:text-slate-300": true,
    "dark:data-[is-active=true]:bg-slate-800": true,
    "dark:aria-selected:bg-slate-800": true,
    "dark:ring-slate-700": true,
    "dark:data-[is-active=true]:ring-slate-600": true,
    "dark:aria-selected:ring-slate-600": true,
    ...
    "dark:[&.formkit-dropZone]:bg-slate-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-slate-900": true,
    "dark:[&.formkit-touchDropZone]:bg-slate-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-slate-900": true,
    "dark:[&.formkit-longTouch]:bg-slate-900": true,
  },
  ...
  transferlist__transferlistSearch: {
    ...
    "dark:border-slate-700": true,
    "dark:text-slate-300": true,
    "dark:selection:bg-slate-100": true,
    "dark:selection:text-slate-700": true,
    "dark:bg-slate-800": true,
  },
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-slate-700": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-slate-500":
      true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-slate-500":
      true,
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-slate-500": true,
