 ...
 *
 * @checksum - 855d3164d35d243ad88989cff0312903d9397063e96ca1ce22879eb9d2542f8d
 * @variables - radius=rounded-none,accentColor=emerald,colorTemperature=stone,spacing=2.5,scale=lg,inputShadow=shadow-lg,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded-none,swatchRadius=rounded-none
 * @theme - regenesis
 */
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:shadow-2xl": true,
  ...
  range__input: {
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-stone-600":
      true,
  ...
  togglebuttons__input: {
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-emerald-500":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-emerald-600":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-emerald-600":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-emerald-600":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-emerald-600":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-emerald-600":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-emerald-500":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-emerald-600":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-emerald-600":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-emerald-600":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-emerald-600":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-emerald-600":
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=progress]/wrapper:group-data-[hide-labels=true]/wrapper:mb-4":
      true,
  },
  "multi-step__tab": {
    "group/tab": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-stone-600":
      true,
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-emerald-600":
      true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-emerald-600":
      true,
  },
